...
class BookingControllerTest {
    ...
    @Test
    void testBookingAddNewRequest_ShouldReturnError_WhenBookingRequestDtoStartDateIsNull() throws Exception {
        // given
        Long userId = 1L;

        BookingRequestDto requestDto = new BookingRequestDto(1L, null, LocalDateTime.now().plusHours(5));
    ...
    @Test
    void testBookingAddNewRequest_ShouldReturnError_WhenBookingRequestDtoEndDateIsNull() throws Exception {
        // given
        Long userId = 1L;

        BookingRequestDto requestDto = new BookingRequestDto(1L, LocalDateTime.now().plusHours(2), null);
        BookingDto bookingDto = BookingDto.builder()
                .id(1L)
                .item(new Item())
                .end(null)
    ...
    @Test
    void testBookingAddNewRequest_ShouldReturnError_WhenBookingRequestDtoItemIdNegative() throws Exception {
        // given
        Long userId = 1L;
