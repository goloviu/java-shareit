...
class UserControllerTest {
    ...
    @Test
    void testSaveNewUser_ShouldReturnError_WhenUserRegisterDtoNameIsNull() throws Exception {
        // given
        UserRegisterDto userRegisterDto = UserRegisterDto.builder()
                .email("teseemail@email.ru")
                .build();
    ...
    @Test
    void testSaveNewUser_ShouldReturnError_WhenUserRegisterDtoEmailIsNull() throws Exception {
        // given
        UserRegisterDto userRegisterDto = UserRegisterDto.builder()
                .name("Test name")
                .build();
