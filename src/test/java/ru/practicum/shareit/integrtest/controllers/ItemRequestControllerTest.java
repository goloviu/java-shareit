...
class ItemRequestControllerTest {
    ...
    @Test
    void testMakeRequest_ShouldReturnError_WhenRequestDescriptionIsNull() throws Exception {
        // given
        Long userId = 1L;
        ...
        when(itemRequestService.addNewRequest(userId, new NewItemRequestDto()))
    ...
    @Test
    void testMakeRequest_ShouldReturnError_WhenUserIdIsNull() throws Exception {
        // given
        Long userId = 1L;
